 ...
 * - 5: Average of eight 3 hr AP indicies from 12 to 33 hrs prior to current
 * time
 ...
 * -  7: diurnal
 * -  8: semidiurnal
 * -  9: daily ap [when this is set to -1 (!) the pointer ap_a in struct
 * nrlmsise_input must point to a struct ap_array]
...
class Nrlmsise00 {
  ...
  public:
    /**
     * @brief Construct a new Nrlmsise00 object
     *
