...
void Nrlmsise00Test::Test1()
{
    ...
    // Check densities
    ref_density = { 6.665177E+05, 1.138806E+08, 1.998211E+07, 4.022764E+05, 3.557465E+03,
...
void Nrlmsise00Test::Test2()
{
    ...
    // Check densities
    ref_density = { 3.407293E+06, 1.586333E+08, 1.391117E+07, 3.262560E+05, 1.559618E+03,
...
void Nrlmsise00Test::Test3()
{
    ...
    // Check densities
    ref_density = { 1.123767E+05, 6.934130E+04, 4.247105E+01, 1.322750E-01, 2.618848E-05,
...
void Nrlmsise00Test::Test4()
{
    ...
    // Check densities
    ref_density = { 5.411554E+07, 1.918893E+11, 6.115826E+12, 1.225201E+12, 6.023212E+10,
...
void Nrlmsise00Test::Test5()
{
    ...
    // Check densities
    ref_density = { 1.851122E+06, 1.476555E+08, 1.579356E+07, 2.633795E+05, 1.588781E+03,
...
void Nrlmsise00Test::Test6()
{
    ...
    // Check densities
    ref_density = { 8.673095E+05, 1.278862E+08, 1.822577E+07, 2.922214E+05, 2.402962E+03,
...
void Nrlmsise00Test::Test7()
{
    ...
    // Check densities
    ref_density = { 5.776251E+05, 6.979139E+07, 1.236814E+07, 2.492868E+05, 1.405739E+03,
...
void Nrlmsise00Test::Test8()
{
    ...
    // Check densities
    ref_density = { 3.740304E+05, 4.782720E+07, 5.240380E+06, 1.759875E+05, 5.501649E+02,
...
void Nrlmsise00Test::Test9()
{
    ...
    // Check densities
    ref_density = { 6.748339E+05, 1.245315E+08, 2.369010E+07, 4.911583E+05, 4.578781E+03,
...
void Nrlmsise00Test::Test10()
{
    ...
    // Check densities
    ref_density = { 5.528601E+05, 1.198041E+08, 3.495798E+07, 9.339618E+05, 1.096255E+04,
...
void Nrlmsise00Test::Test11()
{
    ...
    // Check densities
    ref_density = { 1.375488E+14, 0.000000E+00, 2.049687E+19, 5.498695E+18, 2.451733E+17,
...
void Nrlmsise00Test::Test12()
{
    ...
    // Check densities
    ref_density = { 4.427443E+13, 0.000000E+00, 6.597567E+18, 1.769929E+18, 7.891680E+16,
...
void Nrlmsise00Test::Test13()
{
    ...
    // Check densities
    ref_density = { 2.127829E+12, 0.000000E+00, 3.170791E+17, 8.506280E+16, 3.792741E+15,
...
void Nrlmsise00Test::Test14()
{
    ...
    // Check densities
    ref_density = { 1.412184E+11, 0.000000E+00, 2.104370E+16, 5.645392E+15, 2.517142E+14,
...
void Nrlmsise00Test::Test15()
{
    ...
    // Check densities
    ref_density = { 1.254884E+10, 0.000000E+00, 1.874533E+15, 4.923051E+14, 2.239685E+13,
...
void Nrlmsise00Test::Test16()
{
    ...
    // Check densities
    ref_density = { 5.196477E+05, 1.274494E+08, 4.850450E+07, 1.720838E+06, 2.354487E+04,
...
void Nrlmsise00Test::Test17()
{
    ...
    // Check densities
    ref_density = { 4.260860E+07, 1.241342E+11, 4.929562E+12, 1.048407E+12, 4.993465E+10,
